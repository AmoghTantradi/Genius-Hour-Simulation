...
public class Bomb extends Rectangle2D.Double implements SimulationObject {
	...
	public Bomb() {
		this(Constants.width/2,-Constants.Bomb_height,Constants.default_magnitude,Constants.default_height);
	}
	public Bomb(double x, double y,int magnitude, int height) {
